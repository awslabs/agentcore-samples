...
echo -e "${BLUE}"
echo "=================================================================================="
echo "  Refund Desk — AgentCore Harness Lifecycle Hooks (Lambda · SNS · EventBridge)"
echo "=================================================================================="
echo -e "${NC}"
...
echo "  Waiting for backend (this includes AWS resource provisioning, usually 1-2 minutes)..."
MAX_WAIT=360
ELAPSED=0
