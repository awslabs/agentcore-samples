"""
Deploy a Strands + Bedrock agent to AgentCore Runtime V2 using direct code deployment.
...
def create_runtime(role_arn: str) -> dict:
    ...
    response = control.create_agent_runtime(
        ...
        description="Strands agent with Bedrock model on Runtime V2 — tutorial example",
    )
