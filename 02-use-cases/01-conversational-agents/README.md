...
| [multi-agent-devops-triage-typescript](./multi-agent-devops-triage-typescript/) | IT / DevOps | Advanced | Runtime (HTTP + A2A), Gateway; Claude Agent SDK in TypeScript with IAM/SigV4 auth throughout |
